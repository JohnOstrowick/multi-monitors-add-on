...
function copyClass (s, d) {
	if (!s || !d) {
        global.log("Error: Source or Destination class is undefined", s, d);
        return;
    }
...
class MultiMonitorsAddOn {
    ...
    _showThumbnailsSlider() {
		...
		this.syncWorkspacesActualGeometry = Main.layoutManager._workspacesDisplay._syncWorkspacesActualGeometry;
		Main.layoutManager._workspacesDisplay._syncWorkspacesActualGeometry = function() {
	...
	_hideThumbnailsSlider() {
        ...
        Main.mmOverview = null;
        Main.layoutManager._workspacesDisplay._syncWorkspacesActualGeometry = this.syncWorkspacesActualGeometry;
    }
